...
from DOLLY.utils.decorators.play import PlayWrapper
from DOLLY.utils.database import is_served_user
...
@app.on_callback_query(filters.regex("NOTTYmousAdmin") & ~BANNED_USERS)
async def NOTTYmous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
